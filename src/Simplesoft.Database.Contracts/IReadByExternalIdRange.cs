...
namespace SimpleSoft.Database
{
        ...
        where TId : IEquatable<TId>
    {
        ...
        Task<IEnumerable<TEntity>> ReadByExternalIdAsync(IEnumerable<TId> ids, CancellationToken ct);
        ...
        /// <param name="ids">The collection of ids</param>
        /// <returns>The collection of entities</returns>
        Task<IEnumerable<TEntity>> ReadByExternalIdAsync(CancellationToken ct, params TId[] ids);
    }
